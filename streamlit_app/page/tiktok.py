...
async def show_tiktok_page(host: str) -> None:
    ...
    revenue_comparison = revenue_comparison_for_period(st.session_state.get("tiktok_analytics_period"))
    ...
    should_fetch = (
        ...
        or "daily_rows" not in st.session_state.get("tiktok_analytics_payload", {}).get("data", {}).get("revenue", {})
