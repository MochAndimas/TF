...
def resolve_backend_base_url(*, prefer_internal: bool = True) -> str:
    ...
    Args:
        prefer_internal (bool): Prefer container-to-container host overrides
            such as ``STREAMLIT_API_HOST`` before public or secret-based URLs.

    Returns:
        str: Normalized backend base URL without a trailing slash.
    """
    if prefer_internal:
